        ...
        <div class="home__display">
            ...
            <form @submit.prevent="signup" class="home__display__form">
                ...
                <div class="home__display__form__input">
                    <label for="username" class="home__display__form__input__label">Login</label>
                ...
                <p>Déjà inscrit(e) ? <router-link to="/" class="home__display__form__login">Se connecter</router-link></p>
            </form>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            //S'inscrire puis ensuite page d'accueil (connexion) 
            signup() {
                ...
                .then(() => {
                    this.notyf.success('Création de compte terminée,connectez-vous à présent :).')
                    this.$router.push('/');
                })
                .catch(error => {
...
.home {
        ...
        &__display {background-image: url(../assets/image_de_fond.jpg);
            margin-top: 2rem;
            display: flex;
